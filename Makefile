srcdir = /root/php-5.5.24/ext/pcache
builddir = /root/php-5.5.24/ext/pcache
top_srcdir = /root/php-5.5.24/ext/pcache
top_builddir = /root/php-5.5.24/ext/pcache
EGREP = /bin/grep -E
SED = /bin/sed
CONFIGURE_COMMAND = './configure' '--with-pcache'
CONFIGURE_OPTIONS = '--with-pcache'
SHLIB_SUFFIX_NAME = so
SHLIB_DL_SUFFIX_NAME = so
ZEND_EXT_TYPE = zend_extension
RE2C = exit 0;
AWK = gawk
shared_objects_pcache = pcache.lo
PHP_PECL_EXTENSION = pcache
PHP_MODULES = $(phplibdir)/pcache.la
PHP_ZEND_EX =
...
prefix = /usr/local
phplibdir = /root/php-5.5.24/ext/pcache/modules
